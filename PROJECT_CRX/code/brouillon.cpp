...
int main(int argc, char* argv[])
{
	...
	while (!glfwWindowShouldClose(window)) {
		...
		//Basic shader
		glm::vec3 emissiveColorDefault = glm::vec3(0.0, 0.0, 0.0);
		shader.use();
		...
		shader.setVector3f("emissiveColor", emissiveColorDefault);
		...
		glm::vec3 emissiveColor_coin = glm::vec3(0.1, 0.1, 0.05); //0.3, 0.3, 0.05
